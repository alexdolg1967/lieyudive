import "./dialogs.min.js";
import { b as bodyLockStatus, a as bodyLock, c as bodyUnlock, u as uniqArray } from "./common.min.js";
...
function initSliders() {
  if (document.querySelector(".prodslider")) {
    new Swiper(".prodslider", {
      ...
      */
      // Пагинация
      pagination: {
        el: ".swiper-pagination-prodslider",
        clickable: true
      },
      // Скроллбар
      /*
  ...
  if (document.querySelector(".compslider")) {
    new Swiper(".compslider", {
      // <- Указываем класс нужного слайдера
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Navigation, Pagination],
      ...
      */
      // Пагинация
      pagination: {
        el: ".swiper-pagination-compslider",
        clickable: true
      },
      // Скроллбар
      /*
  ...
  if (document.querySelector(".secslider")) {
    new Swiper(".secslider", {
      // <- Указываем класс нужного слайдера
      // Подключаем модули слайдера
      // для конкретного случая
      modules: [Scrollbar],
...
const moreButtons = document.querySelectorAll(
  ".button--lite.item-catalog__button"
);
  ...
  btn.addEventListener("click", () => {
    document.addEventListener("afterPopupOpen", function(e) {
      ...
      if (currentPopup._dataValue == "popup-more") {
        setTimeout(function() {
          if (document.querySelector(".popup-more .modal-slider")) {
            const thumbnailSlider = new Swiper(
              ".popup-more .modal-thumb-slider",
              {
            ...
            new Swiper(".popup-more .modal-slider", {
              modules: [Navigation, Pagination, Thumb],
              spaceBetween: 10,
              pagination: {
                el: ".swiper-pagination-modal-slider",
                clickable: true
              },
              navigation: {
                nextEl: ".thimb-button-next",
                prevEl: ".thimb-button-prev"
              },
              thumbs: {
...
const moreComponButtons = document.querySelectorAll(
  ".button--lite.item-component__button"
);
moreComponButtons.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    setTimeout(function() {
      if (document.querySelector("#moreDialog").open) {
        if (document.querySelector(".modal-slider")) {
          const thumbnailSlider = new Swiper(".modal-thumb-slider", {
            modules: [Navigation, Thumb],
            spaceBetween: 10,
            slidesPerView: 3,
            freeMode: true,
...
const secVideoPlay = document.querySelectorAll(".item-video__image .btn__play");
secVideoPlay.forEach((secBtn) => {
  secBtn.addEventListener("click", (e) => {
    setTimeout(function() {
      if (document.querySelector("#videoDialog").open) {
        console.log("OPEN");
        ...
        videoWrappers.forEach((videoWrap) => {
          ...
          const btnPlay = videoWrap.querySelector(".btn__play");
