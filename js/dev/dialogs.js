import { d as bodyLockToggle, b as bodyLockStatus, g as gotoBlock, c as bodyUnlock, e as getHash } from "./common.min.js";
(function polyfill() {
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.querySelectorAll(".header__menu > .nav > ul > li > a");
  ...
  window.addEventListener("scroll", function() {
    if (window.scrollY >= 160 && window.scrollY < 500) {
 ...
 * @license GPLv3
 */
var lgVideo_min = lgVideo_min$1.exports;
var hasRequiredLgVideo_min;
function requireLgVideo_min() {
  if (hasRequiredLgVideo_min) return lgVideo_min$1.exports;
  hasRequiredLgVideo_min = 1;
  (function(module, exports) {
    !(function(e, o) {
      module.exports = o();
    })(lgVideo_min, (function() {
      var e = function() {
        return (e = Object.assign || function(e2) {
          for (var o2, i2 = 1, t2 = arguments.length; i2 < t2; i2++) for (var s2 in o2 = arguments[i2]) Object.prototype.hasOwnProperty.call(o2, s2) && (e2[s2] = o2[s2]);
          return e2;
        ...
        return a.prototype.init = function() {
          ...
          if (n2.youtube) {
            ...
            if (t2.tracks) {
              ...
              for (y = 0; y < t2.tracks.length; y++) w(y);
            }
          ...
          if (o2.html5Video && s2.on("mousedown.lg.video", (function(e3) {
            e3.stopPropagation();
          })), this.settings.videojs && (null === (i2 = this.core.galleryItems[o2.index].__slideVideoInfo) || void 0 === i2 ? void 0 : i2.html5)) try {
          ...
          if (this.settings.gotoNextSlideOnVideoEnd) {
            if (s2.html5) t2.on("ended", (function() {
              i2.core.goToNextSlide();
            }));
            else if (s2.vimeo) try {
          ...
          if (i2.get()) {
            ...
            else if (t2.vimeo) try {
              new Vimeo.Player(i2.get())[o2]();
            } catch (e3) {
              console.error("lightGallery:- Make sure you have included //github.com/vimeo/player.js");
            }
            else if (t2.html5) if (this.settings.videojs) try {
              videojs(i2.get())[o2]();
            } catch (e3) {
              console.error("lightGallery:- Make sure you have included videojs");
            }
            else i2.get()[o2]();
            else if (t2.wistia) try {
          ...
          var i2 = this;
          if (e2.hasClass("lg-video-loaded")) o2 && this.playVideo(this.core.index);
          else if (e2.hasClass("lg-has-video")) this.playVideo(this.core.index);
          else {
  ...
  return lgVideo_min$1.exports;
}
var lgVideo_minExports = requireLgVideo_min();
const lgVideo = /* @__PURE__ */ getDefaultExportFromCjs(lgVideo_minExports);
 ...
 * @license GPLv3
 */
var lgAutoplay_min = lgAutoplay_min$1.exports;
var hasRequiredLgAutoplay_min;
function requireLgAutoplay_min() {
  if (hasRequiredLgAutoplay_min) return lgAutoplay_min$1.exports;
  hasRequiredLgAutoplay_min = 1;
  (function(module, exports) {
    !(function(t, o) {
      module.exports = o();
    })(lgAutoplay_min, (function() {
      var t = function() {
        return (t = Object.assign || function(t2) {
          for (var o2, e2 = 1, s2 = arguments.length; e2 < s2; e2++) for (var r2 in o2 = arguments[e2]) Object.prototype.hasOwnProperty.call(o2, r2) && (t2[r2] = o2[r2]);
          return t2;
        }).apply(this, arguments);
  ...
  return lgAutoplay_min$1.exports;
}
requireLgAutoplay_min();
...
const itemCatalogs = document.querySelectorAll(".item-catalog");
itemCatalogs.forEach((item) => {
  const btnMore = item.querySelector(".item-catalog__button.btn-more");
  btnMore.addEventListener("click", () => {
    document.addEventListener("afterPopupOpen", function(e) {
      const currentPopup = e.detail.popup;
      if (currentPopup._dataValue == "popup-more") {
        new lightGallery(
          document.querySelector(".popup-more [data-fls-gallery]"),
          {
            plugins: [lgThumbnail],
            licenseKey: KEY,
            selector: "a",
        ...
        const btnOrder = document.querySelector(".popup-more .btn-order");
        btnOrder.addEventListener("click", () => {
          console.log("click");
          const prodTitle = document.querySelector(
            ".popup-content__title"
          ).innerHTML;
          const prodCzena = document.querySelector(
            ".popup-content__price"
          ).innerHTML;
          document.querySelector(
            "#orderDialog .dialog-content__title"
          ).innerHTML = `
                Заказ товара<br> <span style="font-size: .7em; line-height: 1; color: var(--accent-color);">
                ${prodTitle}</span>`;
          document.querySelector("#orderDialog #order-title").value = prodTitle;
          document.querySelector("#orderDialog #order-czena").value = prodCzena;
        });
      }
    });
    document.addEventListener("afterPopupClose", () => {
      document.querySelector(
        ".popup-more .modal-slider .swiper-wrapper"
      ).innerHTML = "";
      document.querySelector(
        ".popup-more .modal-thumb-slider .swiper-wrapper"
      ).innerHTML = "";
    });
  });
});
const itemComponents = document.querySelectorAll(".item-component");
itemComponents.forEach((item) => {
  const btnMore = item.querySelector(".item-component__button.btn-more");
  btnMore.addEventListener("click", () => {
    document.addEventListener("afterPopupOpen", function(e) {
      const currentPopup = e.detail.popup;
      if (currentPopup._dataValue == "popup-more") {
        console.log("popup-more");
        setTimeout(function() {
          const gallery = new lightGallery(
            document.querySelector(".popup-more [data-fls-gallery]"),
            {
              plugins: [lgThumbnail],
              licenseKey: KEY,
